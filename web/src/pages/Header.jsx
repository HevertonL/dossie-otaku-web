...
export default function Header() {
  ...
  return (
    <header className="w-full bg-black/80 backdrop-blur-md border-b border-white/10 px-6 py-4 flex justify-between items-center sticky top-0 z-50">
      ...
      <Link to="/" data-cy="header-logo-link" className="text-2xl font-bold text-white hover:text-blue-400 transition-colors">
        ...
        {isAuthenticated && user ? (
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span data-cy="header-user-greeting" className="text-gray-200 hidden md:block">
                Olá, {user.name}
              </span>
            </div>
